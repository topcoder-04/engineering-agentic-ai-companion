...
```mermaid
flowchart TD
    R["Release evidence"] --> G["Identity · capability · ownership · compatibility · risk"]
    G --> W["Orders investigation"]
    W --> P["Observe · propose · admit · effect"]
    P --> E["Trace · evaluate · release"]
    E --> F["Fleet · incident learning · next launch"]
```
